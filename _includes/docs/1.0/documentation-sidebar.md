...
[Report Chargeback ]({{ site.baseurl }}{% link docs/1.0/retrochargeback.md %})  
[Associate transaction Pagador and Antifraud ]({{ site.baseurl }}{% link docs/1.0/linktransaction.md %})  